...
Connection id:    11
Current database: personal_db

Query OK, 0 rows affected (0.346 sec)

mysql> CREATE TABLE CUSTOMERS ( ID INT NOT NULL, NAME VARCHAR(20) NOT NULL, AGE INT NOT NULL, ADDRESS CHAR(25), SALARY DECIMAL(18,2) );
